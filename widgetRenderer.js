...
/* ============================================================
   PERSISTENCE — auto-save so a refresh doesn't wipe your work.
   Uses IndexedDB (same store as the folder handle) instead of
   localStorage — localStorage caps out around 5-10MB, which your
   row counts blow past fast. IndexedDB has far more headroom.
   ============================================================ */
